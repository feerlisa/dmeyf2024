...
modelo <- rpart(
    ...
    xval = 0,
    cp = -0.38115475617644, # esto significa no limitar la complejidad de los splits
    minsplit = 1195, # minima cantidad de registros para que se haga el split
    minbucket = 595, # tamaño minimo de una hoja
